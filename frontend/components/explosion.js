...
export const ExplosionComponent = defineComponent({
  ...
  render() {
    ...
    const backgroundPosition = `-${col * this.props.TILE_SIZE}px -${
      row * this.props.TILE_SIZE
    }px`;
    ...
    return h("div", {
      class: className,
      style: {
        transform: `translate(${this.props.col * this.props.TILE_SIZE}px, ${
          this.props.row * this.props.TILE_SIZE
        }px)`,
